...
import { doc, getDoc, collection, query, orderBy, onSnapshot, addDoc, serverTimestamp } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-firestore.js";

// Mapeo de usuarios a departamentos
...
window.login = async function() {
  ...
  try {
    ...
    const nombreUsuario = email.split('@')[0]; // Nombre corto
...
// CONFIGURAR MENÚ LATERAL SEGÚN USUARIO
